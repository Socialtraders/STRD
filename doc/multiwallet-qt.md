...
In order to support loading of multiple wallets in socialtraders-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is socialtraders.cpp.
...
Changes to socialtraders.cpp
----------------------
socialtraders.cpp is the entry point into socialtraders-qt, and as such, will require some minor modifications to provide hooks for

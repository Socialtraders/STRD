...
/** 
    ...
    ****Note - for socialtraders we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of socialtraders coming in to a transaction

...
/** Utility functions used by the socialtraders Qt UI.
 */
namespace GUIUtil
{
...
// Render socialtraders addresses in monospace font
...
// Parse "socialtraders:" URI into recipient object, return true on successful parsing

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("socialtraders Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a socialtraders address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and socialtraders: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About socialtraders Core"), this);
    aboutAction->setStatusTip(tr("Show information about socialtraders Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for socialtraders"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your socialtraders addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified socialtraders addresses"));
    ...
    openAction->setStatusTip(tr("Open a socialtraders: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the socialtraders Core help message to get a list with possible socialtraders command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("socialtraders Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to socialtraders network", "", count));
}
...
{
    QString strTitle = tr("socialtraders Core"); // default title

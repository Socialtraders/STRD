...
#if defined(NDEBUG)
#error "socialtraders cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
	...
	else if (nHeight < 500 && nHeight >= 250) {
        nSubsidy = 0.1 * COIN;
    }
	else if (nHeight >= 500 && nHeight < 3000) {
        nSubsidy = 1.5 * COIN;
    }
	...
	else if (nHeight >= 30000 && nHeight < 80000) {
        nSubsidy = 50 * COIN;
    }
...
{
    RenameThread("socialtraders-scriptch");

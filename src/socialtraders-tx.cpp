...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("socialtraders Core socialtraders-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  socialtraders-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded socialtraders transaction") + "\n" +
                               "  socialtraders-tx [options] -create [commands]   " + _("Create hex-encoded socialtraders transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded socialtraders transaction

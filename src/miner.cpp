...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != chainActive.Tip()->GetBlockHash())
            return error("socialtradersMiner : generated block is stale");
    }
    ...
    if (!ProcessNewBlock(state, NULL, pblock))
        return error("socialtradersMiner : ProcessNewBlock, block not accepted");
...
{
    LogPrintf("socialtradersMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("socialtraders-miner");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        ...
        LogPrintf("Running socialtradersMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),

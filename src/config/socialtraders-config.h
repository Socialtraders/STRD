/* src/config/socialtraders-config.h.  Generated from socialtraders-config.h.in by configure.  */
/* src/config/socialtraders-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef STRD_CONFIG_H

#define STRD_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.socialtraders.skypool.fr"

/* Define to the full name of this package. */
#define PACKAGE_NAME "socialtraders Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "socialtraders Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "socialtraders"

...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop socialtraders server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "socialtraders server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* socialtraders features */
        {"socialtraders", "masternode", &masternode, true, true, false},
        {"socialtraders", "listmasternodes", &listmasternodes, true, true, false},
        {"socialtraders", "getmasternodecount", &getmasternodecount, true, true, false},
        {"socialtraders", "masternodeconnect", &masternodeconnect, true, true, false},
        {"socialtraders", "masternodecurrent", &masternodecurrent, true, true, false},
        {"socialtraders", "masternodedebug", &masternodedebug, true, true, false},
        {"socialtraders", "startmasternode", &startmasternode, true, true, false},
        {"socialtraders", "createmasternodekey", &createmasternodekey, true, true, false},
        {"socialtraders", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"socialtraders", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"socialtraders", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"socialtraders", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"socialtraders", "getmasternodescores", &getmasternodescores, true, true, false},
        {"socialtraders", "mnbudget", &mnbudget, true, true, false},
        {"socialtraders", "preparebudget", &preparebudget, true, true, false},
        {"socialtraders", "submitbudget", &submitbudget, true, true, false},
        {"socialtraders", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"socialtraders", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"socialtraders", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"socialtraders", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"socialtraders", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"socialtraders", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"socialtraders", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"socialtraders", "checkbudgets", &checkbudgets, true, true, false},
        {"socialtraders", "mnsync", &mnsync, true, true, false},
        {"socialtraders", "spork", &spork, true, true, false},
        {"socialtraders", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"socialtraders", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use socialtradersd, or the -server option to socialtraders-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> socialtraders-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:59362/\n";
}
